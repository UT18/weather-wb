...
const forecast = (lat, lon, callback) => {
    ...
    request({ url, json: true }, (error, { body }) => {
        ...
        if (error) {
            ...
            callback(undefined, body.daily.data[0].summary + ' It is currently ' + body.currently.temperature + ' degrees outside.' + '\n' + 'Temp-High:' + body.daily.data[0].temperatureHigh + ' degrees Temp-Low:' + body.daily.data[0].temperatureLow + ' degrees There is a ' + body.currently.precipProbability + '% chance of rain')
        }
    })
}
